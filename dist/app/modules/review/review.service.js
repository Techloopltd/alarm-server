...
const createReview = (payload, userId) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const isReviewExits = yield prisma_1.default.review.findUnique({ where: { userId } });
    if (isReviewExits) {
        throw new ApiError_1.default(http_status_1.default.BAD_REQUEST, 'User already submitted a review');
    }
