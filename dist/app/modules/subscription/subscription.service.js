...
const getAllSubscription = (filters, paginationOptions) => __awaiter(void 0, void 0, void 0, function* () {
    const { page, limit, skip } = paginationHelper_1.paginationHelpers.calculatePagination(paginationOptions);
    const { searchTerm } = filters, filterData = __rest(filters, ["searchTerm"]);
    const andCondition = [];
    if (searchTerm) {
        const searchAbleFields = subscription_constant_1.subscriptionSearchableFields.map(single => {
            const query = {
                [single]: {
                    contains: searchTerm,
                    mode: 'insensitive',
...
const getSingleSubscription = (id) => __awaiter(void 0, void 0, void 0, function* () {
    const result = yield prisma_1.default.subscription.findUnique({
        where: {
            id,
        },
    });
